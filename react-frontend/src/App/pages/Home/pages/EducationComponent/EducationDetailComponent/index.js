...
const moduleName = "EducationDetailComponent";
          ...
          {this.state.data.map((post) =>
            <div className={cx(`${moduleName}-content-card`)}>
              ...
              <div className={cx(`${moduleName}-content-button`)}>
                  <Link to={`/education/register/${post.id}`}><button className={cx(`${moduleName}-content-button-register`)}>신청하기</button></Link>
                  <Link to="/education"><button className={cx(`${moduleName}-content-button-return`)}>돌아가기</button></Link>
                </div>
            </div>)}
          </div>
        </div>
