...
const moduleName = "EducationRegisterComponent";

class EducationRegisterComponent extends Component {
  constructor() {
    super();
    this.state = {
      data:[
          ...
          <div className={cx(`${moduleName}-agree`)}>
            ...
            <div className={cx(`${moduleName}-agree-content`)}>
              ...
              <div className={cx(`${moduleName}-button`)}>
                ...
                <Link to="/edication"><button className={cx(`${moduleName}-button-return`)}>돌아가기</button></Link>
            </div>
            </div>
          </div>
...
export default EducationRegisterComponent;